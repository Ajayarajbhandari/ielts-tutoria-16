...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-lg border-b animate-slide-down">
      ...
      {links.map((link) => (
        ...
        >
          ...
          {isActivePath(link.path) && (
            <span
              className={`absolute ${
                mobile ? '-left-4' : 'bottom-0 left-0'
              } bg-primary ${
                mobile ? 'w-1 top-0 h-full rounded-r-full' : 'h-0.5 w-full'
